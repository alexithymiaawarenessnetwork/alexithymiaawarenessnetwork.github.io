...
For individual word definitions, see the [Lexicon](lexicon.md).
...
→ Full treatment, intensity levels, and applications: **[Robert Plutchik](plutchik.md)**
...
→ Full treatment, FACS details, and applications: **[Paul Ekman](ekman.md)**
...
**Source:** [Stanford Encyclopedia of Philosophy — Spinoza](https://plato.stanford.edu/entries/spinoza/)
...
**Source:** [The Expression of the Emotions in Man and Animals (Project Gutenberg)](https://www.gutenberg.org/ebooks/1227)
...
→ Full treatment, branches, and applications: **[Gloria Wilcox](wilcox.md)**
...
**Source:** Damasio's lab and writings via [USC Brain and Creativity Institute](https://dornsife.usc.edu/bci/)
...
- [Plutchik](plutchik.md), [Ekman](ekman.md), [Wilcox](wilcox.md) — researcher profiles with full framework detail
- [FAQ](faq.md) — common questions about emotion concepts
- [Books](books.md) — recommended reading on emotion theory
